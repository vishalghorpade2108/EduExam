    ...
    try {
      ...
      if (error.response) {
        ...
        if (status === 404) {
          ...
          alert("Exam is not published yet. Please wait.");
        } else if (status === 405) {
  ...
  return (
    ...
    >
      ...
      <Link to="/" className="flex items-center">
        <img src={logo} alt="EduExam Logo" className="h-28 md:h-36 w-auto" />
      </Link>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center bg-white rounded-3xl px-1">
          <input
            ...
            className="px-3 py-2 text-black outline-none w-32 sm:w-40 md:w-48 font-bold bg-transparent"
          />
          <button
