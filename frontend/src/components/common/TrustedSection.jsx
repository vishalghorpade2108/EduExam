  ...
  return (
    <section className="py-28 bg-white text-center">
      ...
      <h2 className="text-3xl md:text-4xl font-semibold text-[#2a384a] mb-20">
        Trusted by over <span className="text-blue-600">10,000 teachers</span> across the world
      </h2>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center mt-10">
        ...
        <div className="px-12 mb-8 md:mb-0">
          <h3 className="text-4xl font-bold text-[#2a384a]">300+</h3>
        ...
        <div className="px-12">
          <h3 className="text-4xl font-bold text-[#2a384a]">20000+</h3>
